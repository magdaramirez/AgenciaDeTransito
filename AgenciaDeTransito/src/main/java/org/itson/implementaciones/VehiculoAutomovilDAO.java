...
public class VehiculoAutomovilDAO implements IVehiculoDAO{
     ...
     * @throws PersistenciaException en caso de que no haya sido posible registrar el automovil
     */
    @Override
     ...
     * @throws PersistenciaException en caso de que el automovil no se haya encontrado
     */
    @Override
    ...
    /**
     * Metodo que edita un automovil para cambiar la lista de las placas que contiene un automovil
     * @param vAutomovil el automovil a modificar
     * @return el automovil ya modificado
     * @throws PersistenciaException en caso de que no haya sido posible modificar el automovil ingresado
     */
    @Override
