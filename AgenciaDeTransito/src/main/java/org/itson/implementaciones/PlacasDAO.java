...
public class PlacasDAO implements IPlacasDAO {
     ...
     * @throws PersistenciaException en caso de que no se haya podido encontrar alguna placa
     */
    @Override
     ...
     * @throws PersistenciaException en caso de que no se haya podido consultar las placas
     */
    @Override
     ...
     * @throws PersistenciaException en caso de no poder realizar la consulta por algun error de sintaxis
     */
    @Override
